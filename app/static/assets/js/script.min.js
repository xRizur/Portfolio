window.innerWidth < 768 && [].slice.call(document.querySelectorAll("[data-bss-disabled-mobile]")).forEach((function (e) {
    ...
    e && window.addEventListener("scroll", (function () {
        ...
        e.style.display = t > 100 ? "block" : "none"
    }));
    var t = document.querySelector("#mainNav");
    if (t) {
        var o = t.querySelector(".navbar-collapse");
        if (o) {
            var a = new bootstrap.Collapse(o, {toggle: !1}), n = o.querySelectorAll("a");
            for (var r of n) r.addEventListener("click", (function (e) {
                a.hide()
            }))
        }
        var i = function () {
            (void 0 !== window.pageYOffset ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop) > 100 ? t.classList.add("navbar-shrink") : t.classList.remove("navbar-shrink")
        };
